...
class Teams(models.Model):
    ...
    team_id = models.CharField(primary_key=True, max_length=255, serialize=False)
    incoming_webhook_url = models.CharField(max_length=1024)
    incoming_webhook_configuration_url = models.CharField(max_length=1024)
